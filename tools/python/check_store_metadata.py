...
# ok = True
# for locale in glob.glob('android/src/{google,fdroid}/??-??/play/'):
#     ok = check_length(locale + "name.txt", 30) and ok
#     ok = check_length(locale + "subtitle.txt", 30) and ok
#     ok = check_length(locale + "promotional_text.txt", 170) and ok
#     ok = check_length(locale + "description.txt", 4000) and ok
#     ok = check_length(locale + "release_notes.txt", 4000) and ok
#     ok = check_length(locale + "keywords.txt", 100) and ok
